...
<body>
	...
	<form action = "joinOK.do" method = "post" name = "reg_frm">
		<div class="row gtr-uniform">
			<div class="col-12"><input type ="text" name ="id" placeholder="ID" /></div>
			...
			<div class="col-12"><input type ="text" name ="name" placeholder="NAME" /></div>
			<div class="col-12"><input type ="text" name ="eMail" placeholder="EMAIL" /></div>
			<div class="col-12"><input type ="text" name ="address" placeholder="ADDRESS" /></div>
			<div class="col-12">
				<ul class="actions special">
					<li><input type = "submit" value = "회원가입" onclick="infoConfirm()" class="primary"></li>
